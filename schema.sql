...
(
    codice                      integer                                             NOT NULL DEFAULT nextval('annuncio_codice_seq'::regclass),
...
(
    codice                 integer                                            NOT NULL DEFAULT nextval('candidature_codice_seq'::regclass),
...
(
    codice      integer                                             NOT NULL DEFAULT nextval('localita_codice_seq'::regclass),
...
(
    codice        integer        NOT NULL DEFAULT nextval('pagamenti_codice_seq'::regclass),
    annuncio      integer        NOT NULL,
...
(
    codice           integer                                            NOT NULL DEFAULT nextval('preferiti_codice_seq'::regclass),
...
(
    codice           integer                                            NOT NULL DEFAULT nextval('recensioni_codice_seq'::regclass),
...
(
    codice           integer                                            NOT NULL DEFAULT nextval('segnalazioni_codice_seq'::regclass),
